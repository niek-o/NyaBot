...
export default {
    ...
    async execute(interaction: CommandInteraction) {
        ...
        if (!player.queue.current || !player.queue.current.duration) return interaction.reply("there is no music playing.");
